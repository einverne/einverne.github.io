...
[SWELL](https://swell-theme.com/) 是日本国内人气最高的 WordPress 主题之一，由开发者「了」于 2019 年发布，售价 17600 日元（含税），100% GPL 授权，支持多站点使用。SWELL 完全适配 WordPress 块编辑器（Gutenberg），无需 HTML/CSS 知识即可通过鼠标操作直观地创建高质量页面。内置丰富的自定义块（吹き出し、手风琴、广告管理、FAQ 等），提供近 400 项自定义设置，同时在页面加载速度和 SEO 方面也做了深度优化。适合个人博客和企业官网。
