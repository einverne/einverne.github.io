...
BI 的范围需要涵盖大量工具，包括数据源连接、数据准备、数据可视化、数据报表、数据输出等。常见的 BI 工具有：Microsoft Power BI、Tableau 等，国内有 阿里云 Quick BI、FineBI 等。开源方案，包括 [[Apache Superset]]、Hue、[[Redash]]、以及本文介绍的重点 Metabase 等。
