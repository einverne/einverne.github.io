...
tagline: "让双手不离键盘，用 Vim 的方式掌控浏览器"
description: "深入介绍 Surfingkeys Chrome 扩展，与 Vimium 的功能对比，以及为什么它是键盘党更好的选择。"
category: 经验总结
tags: [chrome-extension, vim, keyboard, browser, productivity, surfingkeys]
