...
aliases:
  - "Claude Code /goal 命令介绍"
tagline: "设定完成条件，Claude 跨轮次自动工作直到达成"
description: "Claude Code 推出 /goal 命令，用户只需描述一个完成条件，Claude 就会跨多个 turn 持续工作，由独立的小模型在每轮结束后评估条件是否达成，实现真正的自主目标追踪。本文介绍其工作原理、使用方式，以及与 /loop 和 Stop hook 的对比。"
category: 产品体验
tags: [claude-code, ai-tools, productivity, automation, anthropic, cli]
create_time: 2026-05-13 09:00:00
last_updated: 2026-05-13 09:00:00
---
