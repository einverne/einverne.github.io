...
如果还没有 ChatGPT 帐号，可以直接去官网注册，或者可以[联系我](https://t.me/einverne)，我使用 [[claude relay service]] 自己转发了一下 Claude Code 和 Codex。
...
/logout 退出
/resume 恢复之前的会话
/fork 在保留之前的对话下创建新的会话
/compact 压缩之前的会话
/agent 在运行多个 Agent 的情况下切换活跃的 Agent
```
...
如果要引用 Skill 可以使用 `$` 符号加上 Skill 的名字。
